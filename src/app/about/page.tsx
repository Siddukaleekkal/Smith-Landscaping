...
export const metadata = {
  title: 'About Us | Smith Landscaping',
  description: 'Learn about Smith Landscaping and meet our team.',
};
...
export default function AboutPage() {
  ...
  return (
    <div className="bg-white min-h-screen">
      {/* 1. Split Block (Main Team Photo + Description) */}
      <section className="flex flex-col md:flex-row w-full min-h-[500px] lg:h-[75vh]">
        ...
        <div className="w-full md:w-1/2 bg-enterprise-navy relative overflow-hidden flex items-center justify-center p-12 md:p-24 text-white">
          <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-accent-green/10 rounded-full blur-3xl -translate-y-1/2 translate-x-1/3 pointer-events-none"></div>
          <div className="max-w-md w-full relative z-10">
            ...
            <p className="text-white/80 text-[16px] leading-relaxed mb-10 font-light">
      ...
      {/* 2. Team Grid (Individual Members) */}
      <section className="py-24 px-[5%] bg-[#F8F9FA]" id="leadership">
        <div className="max-w-[1400px] mx-auto">
          <h2 className="text-3xl font-bold text-center text-enterprise-navy mb-16">Meet Our Team</h2>
